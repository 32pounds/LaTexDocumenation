...
\begin{section}{Map and Movement}
 ...
 \end{lstlisting}
  ...
  \begin{section}{Comms Test Results}
  	test.com.comms.CommandHandlerTest \rightarrow {testAdd PASSED}

  	test.com.comms.CommandHandlerTest \rightarrow {testRemove PASSED}

  	test.com.comms.CommandHandlerTest \rightarrow {testGetInstance PASSED}
  \end{section}
